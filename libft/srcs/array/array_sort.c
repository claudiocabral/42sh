...
/*   Updated: 2018/01/12 11:01:59 by ccabral          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*array_find_insertion_point(t_array *array,
						void const *element, t_cmpf cmpf)
{
	void	*begin;
	void	*end;
	void	*middle;
	...
	while (end > begin && middle != end && middle != begin)
	{
